...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = BaseUserAdmin.fieldsets + (
        ("Informații suplimentare", {"fields": ("user_type", "phone_number", "profile_picture", "is_verified")}),
    )
...
class CraftsmanProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informații de bază", {"fields": ("user", "display_name", "county", "city", "coverage_radius_km")}),
        (
            "Profil profesional",
        ...
        (
            ...
            {"fields": ("company_cui", "company_verified_at"), "classes": ("collapse",)},
        ),
        (
            "Linkuri sociale (opțional)",
            {"fields": ("website_url", "facebook_url", "instagram_url"), "classes": ("collapse",)},
        ),
        (
