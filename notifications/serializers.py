...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'priority', 'priority_display', 'is_read', 'action_url',
            'sender_name', 'sender_username', 'created_at', 'read_at',
            'time_since', 'expires_at'
        ]
        read_only_fields = [
            'id', 'created_at', 'read_at', 'sender_name', 'sender_username',
            'time_since', 'notification_type_display', 'priority_display'
        ]
...
class NotificationCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'priority', 'action_url', 'related_object_type',
            'related_object_id', 'expires_at'
        ]
    ...
    def validate(self, data):
        ...
        if bool(related_type) != bool(related_id):
            raise serializers.ValidationError(
                "Atât tipul obiectului cât și ID-ul trebuie să fie furnizate împreună."
            )
...
class NotificationPreferenceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'digest_frequency', 'email_new_orders', 'email_quotes',
            'email_payments', 'email_messages', 'email_reviews', 'email_system',
            'push_new_orders', 'push_quotes', 'push_payments', 'push_messages',
            'push_reviews', 'push_system', 'quiet_hours_start', 'quiet_hours_end',
...
class BulkNotificationSerializer(serializers.Serializer):
    ...
    action = serializers.ChoiceField(choices=[
        ('mark_read', 'Marchează ca citite'),
        ('mark_unread', 'Marchează ca necitite'),
        ('delete', 'Șterge')
    ])
