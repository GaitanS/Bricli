...
urlpatterns = [
    ...
    path(
        "order/<int:pk>/shortlist/<int:craftsman_id>/",
        views.ShortlistCraftsmanView.as_view(),
        name="shortlist_craftsman",
    ),
    path("order/<int:pk>/invitation/accept/", views.AcceptInvitationView.as_view(), name="accept_invitation"),
    path("order/<int:pk>/invitation/decline/", views.DeclineInvitationView.as_view(), name="decline_invitation"),
