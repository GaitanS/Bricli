...
from .models import CraftsmanService, Order, OrderImage, Quote, Review, ReviewImage, Service, ServiceCategory
...
class OrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informații de bază", {"fields": ("client", "title", "description", "service")}),
        ("Locație", {"fields": ("county", "city", "address")}),
        ("Detalii", {"fields": ("budget_min", "budget_max", "urgency", "preferred_date")}),
        ("Status", {"fields": ("status", "assigned_craftsman")}),
