...
class Command(BaseCommand):
    ...
    def create_service_categories(self):
        categories_data = [
            ...
            (
                ...
                "tamplarie-dulgherie",
                "fas fa-hammer",
                "Mobilier, uși, ferestre, structuri din lemn",
            ),
            (
                "Instalații Sanitare",
                "instalatii-sanitare",
                "fas fa-wrench",
                "Instalații sanitare, reparații țevi, montaj obiecte sanitare",
            ),
            (
                "Instalații Electrice",
                "instalatii-electrice",
                "fas fa-bolt",
                "Instalații electrice, reparații, montaj prize și întrerupătoare",
            ),
            (
                "Renovări și Construcții",
                "renovari-constructii",
                "fas fa-hard-hat",
                "Renovări complete, construcții noi, amenajări interioare",
            ),
            ...
            (
                ...
                "pictura-vopsitorie",
                "fas fa-paint-roller",
                "Vopsit pereți, zugrăveli, finisaje decorative",
            ),
            (
                "Instalații de Încălzire",
                "instalatii-incalzire",
                "fas fa-fire",
                "Centrale termice, calorifere, încălzire în pardoseală",
            ),
            ...
            (
                ...
                "fas fa-seedling",
                "Amenajări grădini, întreținere spații verzi",
            ),
            ...
            (
                ...
                "it-tehnologie",
                "fas fa-laptop",
                "Reparații calculatoare, instalări software, rețele",
            ),
    ...
    def create_faqs(self):
        faqs_data = [
            (
                "Cum funcționează Bricli?",
                "Bricli este o platformă care conectează clienții cu meșteri verificați. Postezi o cerere, primești oferte și alegi meșterul potrivit.",
                "General",
            ),
            (
                "Este gratuit să postez o cerere?",
                "Da, postarea cererilor este complet gratuită pentru clienți. Plătești doar pentru serviciul prestat de meșter.",
                "General",
            ),
            (
                "Cum sunt verificați meșterii?",
                "Toți meșterii sunt verificați prin documente de identitate, certificări profesionale și referințe anterioare.",
                "Meșteri",
            ),
            (
                "Pot anula o comandă?",
                "Da, poți anula o comandă înainte ca aceasta să fie acceptată de un meșter. După acceptare, discută cu meșterul pentru modificări.",
                "Comenzi",
            ),
            (
                "Cum las o recenzie?",
                "După finalizarea lucrării, vei primi o notificare pentru a lăsa o recenzie despre experiența ta cu meșterul.",
                "Recenzii",
            ),
        ]
    ...
    def create_testimonials(self):
        testimonials_data = [
            (
                "Maria Popescu",
                "București",
                "Am găsit un electrician excelent prin Bricli. Lucrarea a fost făcută profesional și la timp!",
                5,
                True,
            ),
            (
                "Ion Georgescu",
                "Cluj-Napoca",
                "Platforma foarte ușor de folosit. Am primit 3 oferte în prima zi și am ales cel mai bun preț.",
                5,
                True,
            ),
            (
                "Ana Dumitrescu",
                "Timișoara",
                "Meșterul găsit prin Bricli a renovat complet baia. Rezultatul a depășit așteptările!",
                5,
                True,
            ),
        ]
